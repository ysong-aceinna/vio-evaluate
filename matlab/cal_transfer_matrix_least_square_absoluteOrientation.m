...
% for "MH_02_easy", n = 200;
% for "V1_02_medium", n = 100;
% for "V2_03_difficult", n = 100;

% for "MH_02_easy", n = 120;
% for "V1_02_medium", n = 90;
% for "V2_03_difficult", n = 90;

n =90; %取ref_pose 和 algo_pose 的前n个坐标点，求转换矩阵。
rx = ref_pose_x(1:n,:);
ry = ref_pose_y(1:n,:);
rz = ref_pose_z(1:n,:);
ax = algo_pose_x(1:n,:);
